...
public class SyntaxExceptions extends Exception{
    ...
    public static class InvalidFunctionVariableKeywordException extends SyntaxExceptions{
        public InvalidFunctionVariableKeywordException(){
            super("Expected 'var' or 'arg' at start of Function Variable.");
        }
    }

    public static class InvalidIdentifierException extends SyntaxExceptions{
        public InvalidIdentifierException(){
            super("Identifier not found, Expected Function of Class Name");
        }
    }
